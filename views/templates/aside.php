...
$menuItems = [
    ...
    3 => [
       ...
       'Formularios' => [
            ...
            'Asignacion de Salones' => ['icon' => 'fe fe-calendar fe-16', 'link' => 'form_asignar-salones.php'],
            'Asignacion de grupos' => ['icon' => 'fe fe-calendar fe-16', 'link' => 'form_asignar-grupo_mat.php'],
