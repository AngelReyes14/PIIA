...
try {
  ...
  $usuarioMateria = $consultas->verUsuariosGrupos();
} catch (Exception $e) {
...
<body class="vertical  light  ">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="d-flex justify-content-center align-items-center mb-3 col">
        <p class="titulo-grande"><strong>Asignación de Grupos</strong></p>
      </div>
      <form method="POST" action="../../models/insert.php" enctype="multipart/form-data" id="formRegistroUsuarioCarrera">
        <input type="hidden" name="form_type" value="usuario-carrera">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="usuario" name="usuario" required>
                ...
                <?php foreach ($usuarios as $usuario): ?>
                  <option value="<?php echo $usuario['usuario_id']; ?>"><?php echo htmlspecialchars($usuario['nombre_usuario']); ?></option>
                <?php endforeach; ?>
              </select>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" id="materia" name="materia" required>
                <option value="">Selecciona una Salon</option>
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <div class="d-flex justify-content-center align-items-center mb-3 col">
          <p class="titulo-grande"><strong>Grupos Asignados</strong></p>
        </div>
        <div class="row my-4">
          <!-- Small table -->
          <div class="col-md-12">
            <div class="card shadow">
              <div class="card-body">
                ...
                <table class="table datatables" id="dataTable-1">
                  ...
                  <tbody>
                    <?php foreach ($usuarioMateria as $usuarioMateria): ?>
                      <tr>
                        <td><?php echo htmlspecialchars($usuarioMateria['nombre_usuario']); ?></td>
                        <td><?php echo htmlspecialchars($usuarioMateria['nombre_grupo']); ?></td>
                        <td><?php echo htmlspecialchars($usuarioMateria['nombre_materia']); ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
