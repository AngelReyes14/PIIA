...
try {
  ...
  $usuarioCarrera = $consultas->verUsuariosCarreras();
} catch (Exception $e) {
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        <div class="d-flex justify-content-center align-items-center mb-3 col">
          <p class="titulo-grande"><strong>Registro de Grupos</strong></p>
        </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre_grupo" name="nombre_grupo" placeholder="" required>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control" id="turno" name="turno" required>
                  ...
                  <?php foreach ($turnos as $turno): ?>
                    <option value="<?php echo $turno['turno_id']; ?>"><?php echo htmlspecialchars($turno['descripcion']); ?></option>
                  <?php endforeach; ?>
                </select>
                <div class="invalid-feedback">Este campo no puede estar vacío.</div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="semestre" name="semestre" placeholder="" min="1" max="12" required>
                <div class="invalid-feedback">Este campo no puede estar vacío.</div>
              </div>
            </div>
            </div>
          ...
          <div class="row mb-3">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="ciclo_escolar" name="ciclo_escolar" required>
                  ...
                  <?php foreach ($ciclos as $ciclo): ?>
                    <option value="<?php echo $ciclo['ciclo_id']; ?>"><?php echo htmlspecialchars($ciclo['descripcion']); ?></option>
                  <?php endforeach; ?>
                </select>
                <div class="invalid-feedback">Este campo no puede estar vacío.</div>
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="capacidad" name="capacidad" placeholder="" min="1" required>
                <div class="invalid-feedback">Este campo no puede estar vacío.</div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="docente_tutor" class="form-label">Tutor:</label>
                <select class="form-control" id="docente_tutor" name="docente_tutor">
                  <option value=""></option>
                  <?php foreach ($docentes as $docente): ?>
                    <option value="<?php echo $docente['docente_id']; ?>"><?php echo htmlspecialchars($docente['nombre_docente']); ?></option>
                  <?php endforeach; ?>
                </select>
                <div class="invalid-feedback">Este campo no puede estar vacío.</div>
              </div>
