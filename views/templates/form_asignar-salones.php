...
<body class="vertical  light  ">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="d-flex justify-content-center align-items-center mb-3 col">
        <p class="titulo-grande"><strong>Asignacion de Salones</strong></p>
      </div>
      <form method="POST" action="../../models/insert.php" enctype="multipart/form-data" id="formRegistroUsuarioCarrera">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="carrera" class="form-label">Edificio:</label>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="periodo" class="form-label">Salon:</label>
        ...
        <div class="row mt-3">
          <div class="col-md-12 text-center mb-3">
            <button type="submit" class="btn btn-success btn-lg">Asignar Salon</button>
          </div>
        </div>
      </form>
    </div>
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <div class="d-flex justify-content-center align-items-center mb-3 col">
          <p class="titulo-grande"><strong>Salones Asignados</strong></p>
        </div>
        <div class="row my-4">
          <!-- Small table -->
          <div class="col-md-12">
