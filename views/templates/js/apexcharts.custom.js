...
//Grafica de barras que esta en evaluacion docente
var chartOptions = {
  series: [
    {
...
// Inicializar primer gráfico en el primer contenedor
var columnChart1Ctn = document.querySelector("#columnChart");
if (columnChart1Ctn) {
  var columnChart1 = new ApexCharts(columnChart1Ctn, chartOptions);
  columnChart1.render();
}

// Inicializar segundo gráfico en el segundo contenedor
var columnChart2Ctn = document.querySelector("#columnChart2");
if (columnChart2Ctn) {
  var columnChart2 = new ApexCharts(columnChart2Ctn, chartOptions);
  columnChart2.render();
}

// Inicializar segundo gráfico en el tercer contenedor
var columnChart3Ctn = document.querySelector("#columnChart3");
if (columnChart3Ctn) {
  var columnChart3 = new ApexCharts(columnChart3Ctn, chartOptions);
  columnChart3.render();
}
// Inicializar segundo gráfico en el tercer contenedor
var columnChart4Ctn = document.querySelector("#columnChart4");
if (columnChart4Ctn) {
  var columnChart4 = new ApexCharts(columnChart4Ctn, chartOptions);
  columnChart4.render();
}
...
lineChartWidgetCtn &&
  ...
  radialbarWidgetOptions = {
      ...
      chart: { 
          type: "radialBar", 
          height: '100%', // Cambiar a un valor porcentual para que se ajuste al contenedor
          width: '100%'
      },
      theme: { mode: colors.chartTheme },
      plotOptions: {
...
bubblechartCtn &&
  ...
  var donutChartOptions = {
    series: [37.5, 46.9, 15.6], // Datos de ejemplo
    chart: { 
      type: "donut", 
      height: '300px', // Tamaño fijo para evitar que se deforme
      width: '100%',  // Ancho ajustado al 100% del contenedor
      responsive: [{
        breakpoint: 768, // Para pantallas pequeñas
        options: {
          chart: {
            height: 200 // Ajusta la altura en pantallas pequeñas
          },
          legend: {
            position: 'bottom'
          }
    ...
    labels: ["Licenciatura", "Ingeniería", "Maestría"],
    legend: {
      position: "bottom",
      markers: {
        width: 10,
  ...
  if (donutChart1Ctn) {
    var donutChart1 = new ApexCharts(donutChart1Ctn, donutChartOptions);
    donutChart1.render();
  }
  
  // Initialize the second donut chart
  var donutChart2Ctn = document.querySelector("#donutChart2");
  if (donutChart2Ctn) {
    var donutChart2 = new ApexCharts(donutChart2Ctn, donutChartOptions);
    donutChart2.render();
  }
